...
\begin{mathpar}
\inferrule[T-Comm]{G_i\vdash \Pair{p[P_i]\ppar\mathsf q[Q_i]\ppar\MM} W \quad \forall i\in I\subseteq J}
...
\inferrule[T-Act]{G\vdash\Pair{\mathsf p[P]\ppar\MM} W\quad\langle W\rangle\;a\;\langle W'\rangle}
  { a@\mathsf{p}.\,G\vdash\Pair{\mathsf p[a.P]\ppar\MM} {W'}
   }
   
   \inferrule[T-Goal]{G\vdash\Pair{\MM} W\quad W\vDash\varphi}
...
\begin{mathpar}
\inferrule[G-Comm-I]{(G_i,W)\reach^\Lambda (G_i',W')~\forall i\in I\quad\prt{\Lambda}\cap\set{\mathsf{p},\mathsf{q}}=\emptyset}
  {(\mathsf p{\to}\mathsf q{:}\{\ell_i.G_i\}_{i\in I},\,W)\reach^{\Lambda}(\mathsf p{\to}\mathsf q{:}\{\ell_i.G'_i\}_{i\in I},\,W')}
\and
\inferrule[G-Act-I]{(G,W)\reach^\Lambda (G',W')\quad\prt{\Lambda}\cap\set{\mathsf{p}}=\emptyset}
  {(a@\mathsf p.\,G,\,W)\reach^{\Lambda}(a@\mathsf p.G',\,W')}
\and
\inferrule[G-Goal-I]{ (G,W)\reach^\Lambda (G',W')}
